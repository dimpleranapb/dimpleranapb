      ...
      <div className="container ">
        ...
        <div className="flex flex-col mt-10 md:mt-20 gap-20">
          {portfolioProjects.map((project, index) => (
            <div
            className="bg-gray-800 px-8 pt-8 mt-2 md:pt-5 md:px-10 lg:pt-16 lg:px-20 rounded-3xl relative z-0 after:z-10 overflow-hidden after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 after:pointer-events-none"
  ...
  <div className="lg:pb-16">
              ...
              <ul className="flex flex-col gap-4 mt-4 md:mt-5">
                {project.results.map((result) => (
                 <span> <li className="flex gap-2 text-sm md:text-base text-white/50">
                  <CheckCircleIcon className="size-5 md:size-6" />
                  {result.title}</li></span>
                ))}
              </ul>
              <a href={project.link}>
